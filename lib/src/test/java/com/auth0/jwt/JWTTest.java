...
public class JWTTest {
	...
	public void shouldCreateAnEmptyRSA256SignedToken() throws Exception {
		...
		JWTVerifier verified = JWT.require(Algorithm.RSA256((RSAKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_RSA, "RSA"))).build();
		assertThat(verified, is(notNullValue()));
	}
	...
	public void shouldCreateAnEmptyRSA384SignedToken() throws Exception {
		...
		JWTVerifier verified = JWT.require(Algorithm.RSA384((RSAKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_RSA, "RSA"))).build();
		assertThat(verified, is(notNullValue()));
	}
	...
	public void shouldCreateAnEmptyRSA512SignedToken() throws Exception {
		...
		JWTVerifier verified = JWT.require(Algorithm.RSA512((RSAKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_RSA, "RSA"))).build();
		assertThat(verified, is(notNullValue()));
	}
	...
	public void shouldCreateAnEmptyECDSA256SignedToken() throws Exception {
		...
		JWTVerifier verified = JWT.require(Algorithm.ECDSA256((ECKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_EC_256, "EC"))).build();
		assertThat(verified, is(notNullValue()));
	}
	...
	public void shouldCreateAnEmptyECDSA384SignedToken() throws Exception {
		...
		JWTVerifier verified = JWT.require(Algorithm.ECDSA384((ECKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_EC_384, "EC"))).build();
		assertThat(verified, is(notNullValue()));
	}
	...
	public void shouldCreateAnEmptyECDSA512SignedToken() throws Exception {
		...
		JWTVerifier verified = JWT.require(Algorithm.ECDSA512((ECKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_EC_512, "EC"))).build();
		assertThat(verified, is(notNullValue()));
	}
}
