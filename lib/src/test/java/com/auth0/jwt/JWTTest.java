...
import com.auth0.jwt.algorithms.AlgorithmImplementation;
...
public class JWTTest {
    ...
    public void shouldVerifyDecodedToken() throws Exception {
        ...
        DecodedJWT jwt = JWT.require(AlgorithmImplementation.RSA512(key))
                .build()
                .verify(decodedJWT);
    ...
    public void shouldAcceptHMAC256Algorithm() {
        String token = "eyJhbGciOiJIUzI1NiIsImN0eSI6IkpXVCJ9.eyJpc3MiOiJhdXRoMCJ9.mZ0m_N1J4PgeqWmi903JuUoDRZDBPB7HwkS4nVyWH1M";
        DecodedJWT jwt = JWT.require(AlgorithmImplementation.HMAC256("secret"))
                .build()
                .verify(token);
    ...
    public void shouldAcceptHMAC384Algorithm() {
        ...
        DecodedJWT jwt = JWT.require(AlgorithmImplementation.HMAC384("secret"))
                .build()
                .verify(token);
    ...
    public void shouldAcceptHMAC512Algorithm() {
        ...
        DecodedJWT jwt = JWT.require(AlgorithmImplementation.HMAC512("secret"))
                .build()
                .verify(token);
    ...
    public void shouldAcceptRSA256Algorithm() throws Exception {
        ...
        RSAKey key = (RSAKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_RSA, "RSA");
        DecodedJWT jwt = JWT.require(AlgorithmImplementation.RSA256(key))
                .build()
                .verify(token);
    ...
    public void shouldAcceptRSA384Algorithm() throws Exception {
        ...
        RSAKey key = (RSAKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_RSA, "RSA");
        DecodedJWT jwt = JWT.require(AlgorithmImplementation.RSA384(key))
                .build()
                .verify(token);
    ...
    public void shouldAcceptECDSA256Algorithm() throws Exception {
        ...
        DecodedJWT jwt = JWT.require(AlgorithmImplementation.ECDSA256(key))
                .build()
                .verify(token);
    ...
    public void shouldAcceptECDSA384Algorithm() throws Exception {
        ...
        DecodedJWT jwt = JWT.require(AlgorithmImplementation.ECDSA384(key))
                .build()
                .verify(token);
    ...
    public void shouldAcceptECDSA512Algorithm() throws Exception {
        ...
        DecodedJWT jwt = JWT.require(AlgorithmImplementation.ECDSA512(key))
                .build()
                .verify(token);
    ...
    public void shouldGetExpirationTime() {
        ...
        JWTVerifier.BaseVerification verification = (JWTVerifier.BaseVerification) JWT.require(AlgorithmImplementation.HMAC256("secret"));
    ...
    public void shouldCreateAnEmptyHMAC256SignedToken() {
        String signed = JWT.create().sign(AlgorithmImplementation.HMAC256("secret"));
        ...
        JWTVerifier verified = JWT.require(AlgorithmImplementation.HMAC256("secret"))
                .build();
    ...
    public void shouldCreateAnEmptyHMAC384SignedToken() {
        String signed = JWT.create().sign(AlgorithmImplementation.HMAC384("secret"));
        assertThat(signed, is(notNullValue()));
        ...
        JWTVerifier verified = JWT.require(AlgorithmImplementation.HMAC384("secret"))
                .build();
        assertThat(verified, is(notNullValue()));
    }
    ...
    public void shouldCreateAnEmptyHMAC512SignedToken() {
        String signed = JWT.create().sign(AlgorithmImplementation.HMAC512("secret"));
        assertThat(signed, is(notNullValue()));
        ...
        JWTVerifier verified = JWT.require(AlgorithmImplementation.HMAC512("secret"))
                .build();
        assertThat(verified, is(notNullValue()));
    }
    ...
    public void shouldCreateAnEmptyRSA256SignedToken() throws Exception {
        String signed = JWT.create().sign(AlgorithmImplementation.RSA256((RSAKey) PemUtils.readPrivateKeyFromFile(PRIVATE_KEY_FILE_RSA, "RSA")));
        assertThat(signed, is(notNullValue()));
        ...
        JWTVerifier verified = JWT.require(AlgorithmImplementation.RSA256((RSAKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_RSA, "RSA")))
                .build();
        assertThat(verified, is(notNullValue()));
    }
    ...
    public void shouldCreateAnEmptyRSA384SignedToken() throws Exception {
        String signed = JWT.create().sign(AlgorithmImplementation.RSA384((RSAKey) PemUtils.readPrivateKeyFromFile(PRIVATE_KEY_FILE_RSA, "RSA")));
        assertThat(signed, is(notNullValue()));
        ...
        JWTVerifier verified = JWT.require(AlgorithmImplementation.RSA384((RSAKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_RSA, "RSA")))
                .build();
        assertThat(verified, is(notNullValue()));
    }
    ...
    public void shouldCreateAnEmptyRSA512SignedToken() throws Exception {
        String signed = JWT.create().sign(AlgorithmImplementation.RSA512((RSAKey) PemUtils.readPrivateKeyFromFile(PRIVATE_KEY_FILE_RSA, "RSA")));
        assertThat(signed, is(notNullValue()));
        ...
        JWTVerifier verified = JWT.require(AlgorithmImplementation.RSA512((RSAKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_RSA, "RSA")))
                .build();
        assertThat(verified, is(notNullValue()));
    }
    ...
    public void shouldCreateAnEmptyECDSA256SignedToken() throws Exception {
        String signed = JWT.create().sign(AlgorithmImplementation.ECDSA256((ECKey) PemUtils.readPrivateKeyFromFile(PRIVATE_KEY_FILE_EC_256, "EC")));
        assertThat(signed, is(notNullValue()));
        ...
        JWTVerifier verified = JWT.require(AlgorithmImplementation.ECDSA256((ECKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_EC_256, "EC")))
                .build();
        assertThat(verified, is(notNullValue()));
    }
    ...
    public void shouldCreateAnEmptyECDSA384SignedToken() throws Exception {
        String signed = JWT.create().sign(AlgorithmImplementation.ECDSA384((ECKey) PemUtils.readPrivateKeyFromFile(PRIVATE_KEY_FILE_EC_384, "EC")));
        assertThat(signed, is(notNullValue()));
        ...
        JWTVerifier verified = JWT.require(AlgorithmImplementation.ECDSA384((ECKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_EC_384, "EC")))
                .build();
        assertThat(verified, is(notNullValue()));
    }
    ...
    public void shouldCreateAnEmptyECDSA512SignedToken() throws Exception {
        String signed = JWT.create().sign(AlgorithmImplementation.ECDSA512((ECKey) PemUtils.readPrivateKeyFromFile(PRIVATE_KEY_FILE_EC_512, "EC")));
        assertThat(signed, is(notNullValue()));
        ...
        JWTVerifier verified = JWT.require(AlgorithmImplementation.ECDSA512((ECKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_EC_512, "EC")))
                .build();
        assertThat(verified, is(notNullValue()));
    }
}
