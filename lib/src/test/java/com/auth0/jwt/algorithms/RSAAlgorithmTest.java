...
public class RSAAlgorithmTest {
    ...
    public void shouldThrowWhenMacAlgorithmDoesNotExists() throws Exception {
        ...
        when(crypto.verifySignatureFor(anyString(), any(PublicKey.class), any(), any(String.class), any(String.class), any(byte[].class)))
    ...
    public void shouldThrowOnSignWhenSignatureAlgorithmDoesNotExists() throws Exception {
        ...
        CryptoHelper crypto = mock(CryptoHelper.class);
        when(crypto.createSignatureFor(anyString(), any(PrivateKey.class), any(), any(byte[].class), any(byte[].class)))
                .thenThrow(NoSuchAlgorithmException.class);
