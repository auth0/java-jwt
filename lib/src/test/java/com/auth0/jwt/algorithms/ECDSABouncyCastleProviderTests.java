...
public class ECDSABouncyCastleProviderTests {
	...
	// JOSE Signatures obtained using Node 'jwa' lib:
	// https://github.com/brianloveswords/node-jwa
	// DER Signatures obtained from source JOSE signature using
	// 'ecdsa-sig-formatter' lib:
	// https://github.com/Brightspace/node-ecdsa-sig-formatter

	// These tests add and use the BouncyCastle SecurityProvider to handle ECDSA
	// algorithms
	...
	public void shouldThrowOnVerifyWhenSignatureAlgorithmDoesNotExists() throws Exception {
		...
		when(crypto.verifySignatureFor(anyString(), any(PublicKey.class), any(byte[].class), any(byte[].class))).thenThrow(NoSuchAlgorithmException.class);
	...
	public void shouldThrowOnVerifyWhenThePublicKeyIsInvalid() throws Exception {
		...
		CryptoHelper crypto = mock(CryptoHelper.class);
		when(crypto.verifySignatureFor(anyString(), any(PublicKey.class), any(byte[].class), any(byte[].class))).thenThrow(InvalidKeyException.class);
	...
	public void shouldThrowOnVerifyWhenTheSignatureIsNotPrepared() throws Exception {
		...
		CryptoHelper crypto = mock(CryptoHelper.class);
		when(crypto.verifySignatureFor(anyString(), any(PublicKey.class), any(byte[].class), any(byte[].class))).thenThrow(SignatureException.class);
	...
	public void shouldThrowOnSignWhenSignatureAlgorithmDoesNotExists() throws Exception {
		...
		CryptoHelper crypto = mock(CryptoHelper.class);
		when(crypto.createSignatureFor(anyString(), any(PrivateKey.class), any(byte[].class))).thenThrow(NoSuchAlgorithmException.class);
	...
	public void shouldThrowOnSignWhenThePrivateKeyIsInvalid() throws Exception {
		...
		CryptoHelper crypto = mock(CryptoHelper.class);
		when(crypto.createSignatureFor(anyString(), any(PrivateKey.class), any(byte[].class))).thenThrow(InvalidKeyException.class);
	...
	public void shouldThrowOnSignWhenTheSignatureIsNotPrepared() throws Exception {
		...
		CryptoHelper crypto = mock(CryptoHelper.class);
		when(crypto.createSignatureFor(anyString(), any(PrivateKey.class), any(byte[].class))).thenThrow(SignatureException.class);
